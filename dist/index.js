...
;// CONCATENATED MODULE: ./src/StorageProducts.js
...
function getCategoryProducts(prodCategory) {
...
;// CONCATENATED MODULE: ./src/DOMCategory.js
...
function renderProductsList(list, wrapper) {
 ...
 for (let i = 0; i < list.lenght; i++) {
  ...
  if (list[i].new === true) {
   ...
   newProdDOM.classList.add('overline color__accent');
